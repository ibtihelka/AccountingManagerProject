...
public class KeyValue implements Serializable {
	...
	private static final long serialVersionUID = 4095221120086384410L;
			...
			/// </remarks>
			private KeyValue []		suppKeyValues;
			public Key getKey() {
				return key;
			}
			public TextBlock[] getKeyBlocks() {
				return keyBlocks;
			}
			...
			public TextBlock[] getValueBlocks() {
				return valueBlocks;
			}
			...
			public KeyValue[] getSuppKeyValues() {
				return suppKeyValues;
			}
			public void setKey(Key key) {
				this.key = key;
			}
			public void setKeyBlocks(TextBlock[] keyBlocks) {
			...
			public void setValueBlocks(TextBlock[] valueBlocks) {
			...
			public void setSuppKeyValues(KeyValue[] suppKeyValues) {
			...
			public KeyValue (Key key, TextBlock [] keyBlocks, KeyString str, TextBlock basicKeyBlock){
			...
			/// <param name="str">Dans le cas où la Clé a été trouvé alors
			/// la chaine de caractères utilisé lors de la recherche.</param>
			public KeyValue (Key key, TextBlock [] keyBlocks, KeyString str){
			...
			public KeyValue getSuppKeyValue (TextBlock [] keyBlocks)
			...
			public static int getLength (KeyValue [] keyValues, int minLength, Map<Character,Object> charsDictionary)
			{
				int			length = 0;
			...
			/// <param name="charsDictionary">Dictionnaire qui contient les caractères utilisés.</param>
			/// <returns>Entier qui représente la somme des longueurs.</returns>
			public static int getLength (KeyValue [] keyValues, Map<Character,Object> charsDictionary)
			...
			public static KeyValue [] Merge (KeyValue [] keyValues1, KeyValue [] keyValues2)
			{
				...
				{
					KeyValue []		mergedKeyValues = new KeyValue [keyValues1.length + keyValues2.length];
					mergedKeyValues=Arrays.copyOfRange (keyValues1, 0,keyValues1.length);
					mergedKeyValues=Arrays.copyOfRange (keyValues2, 0,keyValues2.length);
