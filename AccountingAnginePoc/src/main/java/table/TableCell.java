...
public class TableCell extends Block implements Serializable {
	...
	private static final long serialVersionUID = 6780573870100153621L;
			...
			public TableCell (int rowIndex, int columnIndex, TextBlock [] textBlocks) 
			{
				super(null, textBlocks);
			...
			public  TextBlock [] GetInnerBlocks ()
			{return (TextBlock [])super.GetInnerBlocks ();}
			/// <summary>
