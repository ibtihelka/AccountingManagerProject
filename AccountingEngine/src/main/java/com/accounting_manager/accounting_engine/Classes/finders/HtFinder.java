...
@Log4j2
public class HtFinder extends KeyFinder<Double> implements Serializable {
    ...
    public HtFinder(boolean isSecondProcessing) throws Exception {
        super(new Key(KeyType.HT));
        this.isSecondProcessing = isSecondProcessing;
    }

    public HtFinder(boolean isSecondProcessing, LearningEngine learningEngine, String fournisseur) throws Exception {
        super(new Key(KeyType.HT), learningEngine, fournisseur);
        this.isSecondProcessing = isSecondProcessing;
    }
    /// <summary>
    /// Initialise une nouvelle instance de la classe
    ...
    /// <param name="learningEngine">L'instance du moteur d'apprentissage.</param>
    /// <param name="fournisseur">Chaine de caractères qui représente le fournisseur. Il peut être null.</param>
    public HtFinder (LearningEngine learningEngine, String fournisseur) throws Exception
    {
    ...
    /// <param name="learningEngine">L'instance du moteur d'apprentissage.</param>
    /// <param name="fournisseur">Chaine de caractères qui représente le fournisseur. Il peut être null.</param>
    public HtFinder() throws Exception {
        this(false);
    }
