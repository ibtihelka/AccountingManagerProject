...
import com.accounting_manager.bank_statement_engine.Classes.finders.NumberFactureFinder;
...
public class Key implements Serializable {
    ...
    public static List<KeyString> GetStrings(KeyType keyType) throws Exception {
        switch (keyType) {
            ...
            case PERIOD_START_DATE:
                return Key.getPeriodStartDateStrings();
            case PERIOD_END_DATE:
                return Key.getPeriodEndDateStrings();
            case TTC:
            ...
            case BIC_NUMBER:
                return Key.getBicNumberStrings();
            case RIB_NUMBER:
                return Key.getRibNumberStrings();
            case IBAN_NUMBER:
                return Key.getIbanNumberStrings();
            case NUMERO_SIRET:
    ...
    /// </summary>
    /// <returns>Tableau de chaine de caractères.</returns>
    private static List<KeyString> getPeriodStartDateStrings() {
        List<KeyString> keyStrings = new ArrayList<>();
    ...
    /// </summary>
    /// <returns>Tableau de chaine de caractères.</returns>
    private static List<KeyString> getPeriodEndDateStrings() {
        List<KeyString> keyStrings = new ArrayList<>();
    ...
    private static List<KeyString> getNumeroRcsStrings() {
        List<KeyString> keyStrings = new ArrayList<>();
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("n"), new KeyStringChar("°", true), new KeyStringChar("compte", true)})));
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("numero"), new KeyStringChar("de", true), new KeyStringChar("compte", true)})));
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("compte"), new KeyStringChar("numero", true)})));
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("compte"), new KeyStringChar("n"), new KeyStringChar("°", true)})));
        return keyStrings;
    }
    ...
    /// Retourne la liste de chaines de caractères
    /// de type <see cref="FacKeyString" /> pour le type
    /// de clé <see cref="FacKeyType.BIC" />.
    /// </summary>
    /// <returns>Tableau de chaine de caractères.</returns>
    private static List<KeyString> getBicNumberStrings() {
        List<KeyString> keyStrings = new ArrayList<>();
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("BIC"), new KeyStringChar(":", true)})));
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("BIC:")})));
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("b.i.c"), new KeyStringChar(":", true)})));
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("b.i.c:")})));
        return keyStrings;

    }

    private static List<KeyString> getRibNumberStrings() {
        List<KeyString> keyStrings = new ArrayList<>();
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("RIB"), new KeyStringChar(":", true)})));
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("RIB:")})));
        return keyStrings;

    }

    private static List<KeyString> getIbanNumberStrings() {
        List<KeyString> keyStrings = new ArrayList<>();
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("IBAN"), new KeyStringChar(":", true)})));
        keyStrings.add(new KeyString(KeyStringCharToList(new KeyStringChar[]{new KeyStringChar("IBAN:")})));
        return keyStrings;
    ...
    public static List<DocumentZone> GetPreferredZones(KeyType keyType) throws Exception {
        switch (keyType) {
            ...
            case PERIOD_START_DATE:
                return Key._GetPeriodStartDatePreferredZones();
            case PERIOD_END_DATE:
                return Key._GetPeriodEndDatePreferredZones();
            case ACCOUNT_NUMBER:
                return Key._GetNumeroRcsPreferredZones();
            case BIC_NUMBER:
                return Key._GetBicPreferredZones();
            case RIB_NUMBER:
                return Key._GetRibPreferredZones();
            case IBAN_NUMBER:
                return Key._GetIbanPreferredZones();
            case NUMERO_SIRET:
    ...
    /// </summary>
    /// <returns>Tableau de zones.</returns>
    private static List<DocumentZone> _GetPeriodStartDatePreferredZones() {
        return DocumentZoneToList(new DocumentZone[]{
                DocumentZone.TOP_LEFT,
                DocumentZone.TOP_RIGHT,
                DocumentZone.BOTTOM_RIGHT,
    ...
    /// </summary>
    /// <returns>Tableau de zones.</returns>
    private static List<DocumentZone> _GetPeriodEndDatePreferredZones() {
        return DocumentZoneToList(new DocumentZone[]{
                DocumentZone.TOP_LEFT,
                DocumentZone.TOP_RIGHT,
                DocumentZone.BOTTOM_RIGHT,
    ...
    /// </summary>
    /// <returns>Tableau de zones.</returns>
    private static List<DocumentZone> _GetBicPreferredZones() {
        return DocumentZoneToList(new DocumentZone[]{
                DocumentZone.MIDDLE_CENTER,
                DocumentZone.MIDDLE_RIGHT,
                DocumentZone.BOTTOM_CENTER,
    ...
    /// Retourne la liste des zones préférées
    /// de type <see cref="FacDocumentZone" /> pour le type
    /// de clé <see cref="FacKeyType.RIB" />.
    /// </summary>
    /// <returns>Tableau de zones.</returns>
    private static List<DocumentZone> _GetRibPreferredZones() {
        return DocumentZoneToList(new DocumentZone[]{
                DocumentZone.MIDDLE_CENTER,
                DocumentZone.MIDDLE_RIGHT,
                DocumentZone.BOTTOM_CENTER,
    ...
    /// Retourne la liste des zones préférées
    /// de type <see cref="FacDocumentZone" /> pour le type
    /// de clé <see cref="FacKeyType.IBAN" />.
    /// </summary>
    /// <returns>Tableau de zones.</returns>
    private static List<DocumentZone> _GetIbanPreferredZones() {
        return DocumentZoneToList(new DocumentZone[]{
                DocumentZone.MIDDLE_CENTER,
                DocumentZone.MIDDLE_RIGHT,
                DocumentZone.BOTTOM_CENTER,
