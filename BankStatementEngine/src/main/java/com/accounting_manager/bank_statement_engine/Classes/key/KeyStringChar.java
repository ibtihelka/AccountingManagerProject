...
public class KeyStringChar  implements Serializable {
	...
	private static Map<String,List<String>> SetBadQualityChars ()
	{
		...
		KeyStringChar.AddBadQualityChar (badQualityChars, "numéro", "numero");
		KeyStringChar.AddBadQualityChar (badQualityChars, "facture", "factur");
		KeyStringChar.AddBadQualityChar (badQualityChars, "facture", "fecture");
		KeyStringChar.AddBadQualityChar (badQualityChars, "facture", "acture");
		KeyStringChar.AddBadQualityChar (badQualityChars, "facture", "ague");
		KeyStringChar.AddBadQualityChar (badQualityChars, "facture", "raclure");
		KeyStringChar.AddBadQualityChar (badQualityChars, "facture", "fac");
	...
	public static List<String> GetBadQualityChars (String charStr)
	{
