...
@Log4j2
public class PeriodStartDateFinder extends KeyFinder<Date> implements Serializable {
    ...
    public PeriodStartDateFinder() throws Exception {
        super(new Key(KeyType.PERIOD_START_DATE));
    }

    public PeriodStartDateFinder(LearningEngine learningEngine, String fournisseur, Date periodEndDate) throws Exception {
        super(new Key(KeyType.PERIOD_START_DATE), learningEngine, fournisseur);
    ...
    private static boolean _IsWrongPeriodStartDate(String keyInvalidator, String prevSeq, String currSeq, String nextSeq) {
    ...
    public boolean _CheckValue(KeyValue keyValue, _Out<Date> periodStartDate) {
        ...
        if (!PeriodStartDateFinder._IsWrongPeriodStartDate("Loi", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("Exercice", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("clos", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("echeance", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("echtance", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("ech6ance", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("6ch6ance", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("edition", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("cave", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("commande", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("mail", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("signe", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("cpter", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("compter", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("prelevee", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("Liv", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("vers", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("soit", prevSeq, currSeq, null)
                && !PeriodStartDateFinder._IsWrongPeriodStartDate("arret", prevSeq, currSeq, null))
        {
            try {
                boolean b = NumberHelper.ConvertDate(currSeq, periodStartDate);
                return b && periodStartDate.get().before(periodEndDate);
            } catch (ParseException e) {
                log.error("An error occurred while converting the period start date: " + e);
                return false;
            }

        } else {
            periodStartDate.set(new Date());
            return false;
        }
    }
    ...
    public boolean CheckValue(KeyValue keyValue, List<Block> allBlocks) {
        _Out<Date> periodStartDate = new _Out<>(null);
        return this._CheckValue(keyValue, periodStartDate);
    }
    ...
    public Date GetValue(KeyValue validKeyValue) {
        _Out<Date> periodStartDate = new _Out<>(null);
        this._CheckValue(validKeyValue, periodStartDate);
