...
@Log4j2
public class TvaSuppFinder extends KeyFinder<Double> implements Serializable {
    ...
    public TvaSuppFinder() throws Exception {

        super(new Key(KeyType.TVA_SUPP));
    }

    public TvaSuppFinder(LearningEngine learningEngine, String fournisseur) throws Exception {

        super(new Key(KeyType.TVA_SUPP), learningEngine, fournisseur);
    }
