...
public class Client {
	...
	public String applicationId ="69585bb9-cf07-45e6-8a4f-14695432344d";
	public String password="E+KFtmpZYOQSd4ntevuAraSM";
	...
	public Task processByteArrayImage(byte[] filePath, ProcessingSettings settings)
			throws Exception {
		URL url = new URL(serverUrl + "/processImage?" + settings.asUrlParams());
		return postFileToUrl(filePath, url);
	}
	...
	public URL getURL(Task task) throws Exception {
		if (task.Status != Task.TaskStatus.Completed) {
			throw new IllegalArgumentException("Invalid task status");
		}
	...
	private Task postFileToUrl(byte[] file, URL url) throws Exception {
